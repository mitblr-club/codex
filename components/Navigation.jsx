...
export default function Navigation() {
	...
	return (
		<>
			<nav className="fixed top-0 left-0 right-0 z-40 flex items-center flex-wrap p-2 bg-purple-600 bg-opacity-75 border-gray-500 shadow-lg backdrop-filter backdrop-blur-md">
